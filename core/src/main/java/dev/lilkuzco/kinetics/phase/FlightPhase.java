...
public enum FlightPhase {
     ...
     */
    public boolean isPowered() { return this == BOOST || this == TERMINAL; }

    /** Whether guidance may command acceleration in this phase. */
    public boolean isGuided() { return this == BOOST || this == MIDCOURSE || this == TERMINAL; }
     ...
     */
    public static final Map<FlightPhase, EnumSet<FlightPhase>> LEGAL = Map.of(
            // Ignition, or a failure to leave the pad at all.
            RAIL, EnumSet.of(BOOST, TERMINATED),
            ...
            BOOST, EnumSet.of(STAGING, MIDCOURSE, TERMINAL, DESCENT, ORBIT, TERMINATED),
            // The next stage lights, or nothing does.
            STAGING, EnumSet.of(BOOST, MIDCOURSE, TERMINATED),
            // Seeker takes over, the body starts falling, or it makes orbit.
            MIDCOURSE, EnumSet.of(TERMINAL, DESCENT, ORBIT, TERMINATED),
            // Terminal ends in an impact one way or another.
            TERMINAL, EnumSet.of(DESCENT, TERMINATED),
            // A fall ends on the ground, or turns out to be hot enough to be a reentry.
            DESCENT, EnumSet.of(REENTRY, LANDED, TERMINATED),
            // Heating peaks and eases back into an ordinary descent.
            REENTRY, EnumSet.of(DESCENT, LANDED, TERMINATED),
            // Orbits decay or are commanded down; either way the body re-enters the world.
            ORBIT, EnumSet.of(DESCENT, REENTRY, TERMINATED),
            LANDED, EnumSet.of(TERMINATED),
            TERMINATED, EnumSet.noneOf(FlightPhase.class));
